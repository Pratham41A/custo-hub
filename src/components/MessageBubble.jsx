...
export function MessageBubble({ msg, onReply, isStarted, allMessages }) {
    ...
    <div style={bubbleStyle}>
      ...
      {repliedMessage && (
        <div
          ...
          onMouseEnter={() => setShowReplyPreview(true)}
          onMouseLeave={() => setShowReplyPreview(false)}
        >
          <div style={{ fontWeight: 600, marginBottom: '4px', opacity: 0.9 }}>
            ↩️ In reply to:
          </div>
          <div style={{ 
            whiteSpace: 'nowrap', 
      ...
      {msg.attachments && msg.attachments.length > 0 && (
        <div style={{ marginTop: '12px', paddingTop: '12px', borderTop: `1px solid ${isSent ? 'rgba(255,255,255,0.2)' : 'rgba(0,0,0,0.1)'}` }}>
